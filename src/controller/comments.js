...
commentsRouter.post('/comment', auth(CommentsPaths), validateBody(schemas.schemaPostComment), async (req, res) => {
    try {
...
commentsRouter.get('/comment/:id', validateParam(schemas.schemaId), auth(CommentsPaths), async (req, res) => {
    try {
...
commentsRouter.delete('/comment/:id', validateParam(schemas.schemaId), auth(CommentsPaths), async (req, res) => {
    try {
